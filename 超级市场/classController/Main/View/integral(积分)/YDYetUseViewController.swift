...
import LTScrollView
import MJRefresh
class YDYetUseViewController: YDBasicViewController,LTTableViewProtocal {
...
//        tableView.uHead = URefreshHeader{ [weak self] in self?.requestSearchGoodsDate() }
    ...
    override func viewDidLoad() {
        ...
        header.setRefreshingTarget(self, refreshingAction: #selector(YDYetUseViewController.headerRefresh))
    ...
    func requestSearchGoodsDate(){
        ...
        integralListModel.refreshCouponDataSource(status: "2", token:  (UserDefaults.LoginInfo.string(forKey: .token)! as NSString) as String, memberPhone: (UserDefaults.LoginInfo.string(forKey: .phone)! as NSString) as String)
    }
}
extension YDYetUseViewController : UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, viewForFooterInSection section: Int) -> UIView? {
        ...
        headerView.IntegralGoods = "您还未有积分支出"

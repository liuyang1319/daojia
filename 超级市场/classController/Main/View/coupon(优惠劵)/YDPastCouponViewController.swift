//
//  YDPastCouponViewController.swift
//  超级市场
//
...
import HandyJSON
import MJRefresh
class YDPastCouponViewController: YDBasicViewController {
    ...
    func requestSearchGoodsDate(){
        ...
        couponListModel.refreshCouponDataSource(status: "3", token:  (UserDefaults.LoginInfo.string(forKey: .token)! as NSString) as String, memberPhone: (UserDefaults.LoginInfo.string(forKey: .phone)! as NSString) as String)
    }
    //    为你推荐
...
extension YDPastCouponViewController : UITableViewDelegate, UITableViewDataSource {
...
extension YDPastCouponViewController : YDHomeRecommendViewDelegate{

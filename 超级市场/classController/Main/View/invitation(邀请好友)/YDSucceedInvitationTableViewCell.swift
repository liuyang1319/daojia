//
//  YDSucceedInvitationTableViewCell.swift
//  超级市场
//
//  Created by 王林峰 on 2019/12/18.
//  Copyright © 2019 王林峰. All rights reserved.
//

import UIKit

class YDSucceedInvitationTableViewCell: UITableViewCell {
    ...
    var inviteSPresentModel:YDInviteLogsSucceedInfoModel? {
        didSet {
            guard let model = inviteSPresentModel else {return}

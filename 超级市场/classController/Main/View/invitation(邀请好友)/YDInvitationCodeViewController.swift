//
//  YDInvitationCodeViewController.swift
//  超级市场
//
...
class YDInvitationCodeViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.titleLabel.frame = CGRect(x: 55, y: self.codeImage.frame.maxY+15, width: 180, height: 40)
    }

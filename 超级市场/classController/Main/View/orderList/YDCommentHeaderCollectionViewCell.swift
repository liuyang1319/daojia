//
//  YDCommentHeaderCollectionViewCell.swift
//  超级市场
//
//  Created by 王林峰 on 2020/1/2.
//  Copyright © 2020 王林峰. All rights reserved.
//

import UIKit
protocol YDCommentHeaderCollectionViewCellDelegate:NSObjectProtocol {
    func GoodsCommentListCollectionView(titleButton:UIButton)
}
class YDCommentHeaderCollectionViewCell: UICollectionViewCell {
    weak var delegate : YDCommentHeaderCollectionViewCellDelegate?

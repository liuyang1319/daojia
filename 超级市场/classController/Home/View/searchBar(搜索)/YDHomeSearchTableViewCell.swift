//
//  YDHomeSearchTableViewCell.swift
//  超级市场
//
...
import UIKit
protocol YDHomeSearchTableViewCellDelegate:NSObjectProtocol {
    //    商品加
    func plusSelctTableViewCell(button:UIButton,cell:YDHomeSearchTableViewCell ,icon: UIImageView)
}
class YDHomeSearchTableViewCell: YDGoodsTableViewCell {
     weak var delegate : YDHomeSearchTableViewCellDelegate?
...
//        self.addSubview(self.vipLabel)
    ...
    var seearchGoodsModel:YDHomeSearchGoodsListModel? {
        didSet {
            ...
            print("----goodsCartCount:\(goodsCartCount)")
        }
    }

...
//        }
    ...
    var navBarBarTintColor: UIColor {
        ...
        set {
            ...
            if customNav.isKind(of: UINavigationBar.self) {
//                let navBar = customNavBar as! UINavigationBar
...
class WRNavigationBar
{
    ...
    {   // default is system attributes
        static var defNavBarBarTintColor: UIColor = UIColor.red
...
extension WRNavigationBar
{
    class func isIphoneX() -> Bool {
        return UIScreen.main.bounds.equalTo(CGRect(x: 0, y: 0, width: LBFMScreenWidth, height: LBFMScreenHeight))
    }
    class func navBarBottom() -> Int {
        return Int(LBFMNavBarHeight)
    }
    class func tabBarHeight() -> Int {
        return Int(LBFMTabBarHeight)
    }
    class func screenWidth() -> Int {
        return Int(LBFMScreenWidth)
    }
    class func screenHeight() -> Int {
        return Int(LBFMScreenHeight)
    }
}

...
extension YHPhotoBrowserController{
    private func setUpUi(){
        ...
        let pageController = UIPageViewController.init(transitionStyle: .scroll, navigationOrientation: .horizontal, options: [UIPageViewController.OptionsKey.interPageSpacing:20])
...
extension YHPhotoBrowserController:UIPageViewControllerDelegate{
    ...
    private func setPageButtonIndex(index:Int){
        ...
        let attributeText = NSMutableAttributedString.init(string: "\(index + 1)", attributes: [NSAttributedString.Key.font : UIFont.systemFont(ofSize: 18),NSAttributedString.Key.foregroundColor:UIColor.white])
        
        attributeText.append(NSAttributedString.init(string: " / \(photos.urls?.count ?? 0)", attributes: [NSAttributedString.Key.font : UIFont.systemFont(ofSize: 14),NSAttributedString.Key.foregroundColor:UIColor.white]))

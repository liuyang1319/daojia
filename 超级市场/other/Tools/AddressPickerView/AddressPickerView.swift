...
final class AddressPickerColor {
    ...
    var cancelBtn = YDLabelColor
    var sureBtn = YDLabelColor
    var barViewBackground = UIColor(red: 239/255.0, green: 239/255.0, blue: 244/255.0, alpha: 1.0)
    ...
    init(cancelBtn: UIColor = YDLabelColor, sureBtn: UIColor = YDLabelColor, barViewBackground: UIColor = UIColor(red: 239/255.0, green: 239/255.0, blue: 244/255.0, alpha: 1.0), pickerViewBackground: UIColor = UIColor.white, pickerRowTitle: UIColor = UIColor(red: 51/255.0, green: 51/255.0, blue: 51/255.0, alpha: 1.0)) {
